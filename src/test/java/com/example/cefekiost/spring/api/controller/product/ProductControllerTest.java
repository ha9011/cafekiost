package com.example.cefekiost.spring.api.controller.product;
...
@WebMvcTest(controllers = ProductController.class) // 컨트롤러 관련 빈만 올리도록 하는 가벼운 테스트 어노테이션
class ProductControllerTest {
    ...
    @MockBean
    private ProductService productService; // ProductController.class이 필요하기 떄문에 빈을 mock으로 일단 만들어둠
