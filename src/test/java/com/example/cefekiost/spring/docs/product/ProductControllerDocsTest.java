package com.example.cefekiost.spring.docs.product;


import com.example.cefekiost.spring.api.controller.product.ProductController;
import com.example.cefekiost.spring.api.controller.product.dto.ProductCreateRequest;
import com.example.cefekiost.spring.api.service.product.ProductService;
...
import com.example.cefekiost.spring.docs.RestDocsSupport;
                ...
                .andDo(document("product-create",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("data.productType").type(JsonFieldType.STRING)
                                        .description("상품 타입"),
                                fieldWithPath("data.productSellingStatus").type(JsonFieldType.STRING)
                                        .description("상품 판매상태"),
